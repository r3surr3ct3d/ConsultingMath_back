...
import GameEst from './GameEst.js'
import { SafeAreaView } from 'react-native-safe-area-context';


const EndlessGameEst = ({ navigation, route }) => {
    ...
    useEffect(() => {
        setComponent(
            <View style={styles.EndlessGame}>
                <Text></Text>
                <GameEst dificult={route.params.dificult} type={route.params.type} setData={setData} setNon={setNon} />
            </View>
        );
    }, [navigation]);
    ...
    useEffect(() => {
        if (nonElem == 0) {
            setComponent(
                <View style={styles.EndlessGame}>
                    <Text></Text>
                    <GameEst dificult={route.params.dificult} type={route.params.type} setData={setData} setNon={setNon} setTimer={setTimer} />
                </View>
            );
        } else {
            let listAnswers = [];
