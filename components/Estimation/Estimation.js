...
const Item = ({ item, onPress, backgroundColor, textColor }) => (
  <TouchableOpacity onPress={onPress} style={[styles.item_1, { backgroundColor }]}>
  ...
  return (
    <View style={styles.main}>
      ...
      <TouchableOpacity style={styles.start}
        onPress={() => {
          if (isEnabled) {
            navigation.navigate('EndlessGameEst', { dificult: selectedId, mode: isEnabled, type: selectedArif });
          } else {
            navigation.navigate('RankedGameEst', { dificult: selectedId, mode: isEnabled, type: selectedArif });
          }
        }
        }>
